...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  <div className="relative min-w-[270px] flex justify-center  rounded-tl-md rounded-tr-md aspect-[617/217] w-full h-auto max-h-[370px] overflow-hidden">
  <img src={sortedImages[0]?.imageUrl || "https://media.istockphoto.com/id/1147544807/vector/thumbnail-image-vector-graphic.jpg?s=612x612&w=0&k=20&c=rnCKVbdxqkjlcs3xH87-9gocETqpspHFXu5dIGB4wuM="} alt=""  
