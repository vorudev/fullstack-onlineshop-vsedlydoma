          ...
          <div className="flex gap-3">
            <Dialog>
              <DialogTrigger asChild>
                <Button size="sm" variant="ghost" className="bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer h-10">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Редактировать заказ в базе данных
                  </DialogDescription>
