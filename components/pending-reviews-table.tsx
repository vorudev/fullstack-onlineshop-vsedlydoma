...
export async function PendingReviewsTable() { 
    const reviews = await getPendingReviews();
    return ( 
          <Table className="w-2/3 mx-auto"> 
        <TableCaption>Список ожидающих модерации отзывов</TableCaption>
        <TableHeader>
          <TableRow >
  ...
  <TableCell className="whitespace-normal break-words max-w-md">
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="ghost" className="text-green-400 hover:text-green-500 hover:bg-green-50">
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Одобрить отзыв</DialogTitle>
