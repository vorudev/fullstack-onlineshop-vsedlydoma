...
export default function ProductList({products}: {products: ProductUnited[]}) {
 ...
 if (products && products.length === 0) {
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:gap-3 lg:pt-5 gap-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3" 
    style={{
...
<div className="lg:block hidden"><ProductCard product={product} /></div>
      ...
      <div className="grid grid-cols-1 lg:pt-5 md:grid-cols-2 gap-2 lg:grid-cols-2 xl:grid-cols-3 " 
      style={{
   // gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))",
  }}>
