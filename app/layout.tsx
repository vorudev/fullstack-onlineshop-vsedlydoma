...
export const metadata: Metadata = {
  title: "Все для дома",
  description: "Магазин Всё для дома в Минске — сантехника, строительные материалы, инструменты и товары для ремонта. Широкий выбор, доступные цены. Консультации специалистов. Проверены временем - более 10 лет на рынке",
