...
export function AddPrivacyPolicy({ privacyPolicy }: PrivacyPolicyFormProps) {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Политика конфиденциальности" {...field} />
                            </FormControl>
                            <FormDescription>Это название, которое будет отображаться на странице политики конфиденциальности</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
...
<FormField
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel>Текст политики конфиденциальности</FormLabel>
      <FormControl>
        <RichTextEditor
          value={field.value}
